...
.nx-rcard.lead .badge{color:var(--navy)!important}
...
/* 统一交互反馈：悬停上浮 + 点击微反馈（卡片是信息块，给优雅反馈而非空白） */
.nx-rcard,.nx-fee,.nx-cc{transition:box-shadow .2s,transform .2s,border-color .2s}
.nx-rcard:hover,.nx-cc:hover{box-shadow:0 16px 38px rgba(13,34,64,.1);transform:translateY(-3px);border-color:#cdd9ea}
.nx-rcard.lead:hover{box-shadow:0 20px 46px rgba(13,34,64,.3);transform:translateY(-3px)}
.nx-fee:hover{box-shadow:0 16px 38px rgba(13,34,64,.1);transform:translateY(-3px)}
.nx-fee.hl:hover{box-shadow:0 18px 44px rgba(200,162,74,.24)}
.nx-fcard:active,.nx-pcard:active,.nx-rcard:active,.nx-fee:active,.nx-cc:active{transform:translateY(-1px) scale(.995)}
...
BODY=f'''<div class="nx">
  ...
  <div class="nx-wrap">
    ...
    <section class="nx-sec nx-prose">
      ...
      <p>它更是<b>亚洲顶尖的研究型大学</b>：与美国<b>杜克大学</b>共建杜克-NUS 研究生医学院，设有 NUS College 荣誉书院、NUS Overseas Colleges 海外创业项目，与全球名校广泛开展双学位与交换——既有百年学术底蕴，也走在科研与创新最前沿。</p>
    ...
    <section class="nx-sec">
      <h2 class="nx-h2">就业与出路</h2>
      <p class="nx-lead">NUS 文凭在就业市场含金量极高。根据 2024 年毕业生就业调查（GES）：</p>
      <div class="nx-rank">
        <div class="big">
          <div class="it"><div class="n">S$4,600</div><div class="l">应届生月薪中位数<br><span style="font-size:.75rem;opacity:.7">2024 · 平均约 S$5,101</span></div></div>
          <div class="it"><div class="n">~100%</div><div class="l">会计 / 牙医等专业就业率</div></div>
          <div class="it"><div class="n">全球前列</div><div class="l">QS 毕业生就业力</div></div>
        </div>
        <div class="subs" style="grid-template-columns:1fr">
