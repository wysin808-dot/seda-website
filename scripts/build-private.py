...
<td>{esc("、".join(s["fields"][:3]))}</td><td>{esc(s['fee'])}</td></tr>''' for s in SCHOOLS)
  ...
  <section class="pv-hero" style="background:linear-gradient(135deg,#241a1e,#7e2d3a)"><div class="in">
    ...
    <a href="/private-university/courses/" style="display:inline-flex;align-items:center;gap:8px;margin-top:16px;background:rgba(255,255,255,.14);border:1px solid rgba(255,255,255,.35);color:#fff;font-weight:700;padding:10px 20px;border-radius:10px;text-decoration:none">📚 直接查 10 所 273 个专业总数据库 →</a>
  </div></section>
  <div class="pv-tools">
